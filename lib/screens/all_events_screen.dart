...
class _AllEventsScreenState extends State<AllEventsScreen> {
  ...
  String _getStationName(int stationId) =>
      MockData.getStationById(stationId)?.stationName ?? '-';
    ...
    setState(() {
      filteredReports = query.isEmpty
          ...
          : reports.where((r) =>
              ...
              _getStationName(r.stationId).contains(query)).toList();
    });
  }
  ...
  Widget _buildReportCard(Report report) {
    ...
    String sevLabel = sev == 'High' ? 'HIGH' : sev == 'Medium' ? 'MED' : 'LOW';
    Color sevBg = sev == 'High' ? AppColors.redLight
        : sev == 'Medium' ? const Color(0xFFFFF3E0) : const Color(0xFFE8F5E9);
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text('#${report.reportId.toString().padLeft(4, '0')}',
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text('${_getStationName(report.stationId)} · ${_getZone(report.stationId)}',
                  ...
                  Row(
                    children: [
                      const Icon(CupertinoIcons.clock, size: 11, color: AppColors.grey300),
                      const SizedBox(width: 4),
            ...
            Column(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: sevBg, borderRadius: BorderRadius.circular(99)),
                  child: Text(sevLabel,
                      style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: sevColor)),
                ),
                const SizedBox(height: 8),
                const Icon(CupertinoIcons.chevron_right, color: AppColors.grey300, size: 16),
              ],
            ),
          ],
        ),
      ...
      child: SafeArea(
        ...
        child: Row(
          children: [
            ...
            _navItem(CupertinoIcons.chart_bar_fill, 'สถิติ', false,
