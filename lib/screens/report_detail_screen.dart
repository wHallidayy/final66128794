...
class _ReportDetailScreenState extends State<ReportDetailScreen> {
  ...
  String _getProvince(int stationId) =>
      MockData.getStationById(stationId)?.province ?? '-';
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text('รายงาน #${r.reportId.toString().padLeft(4, '0')}',
      ...
      children: [
        Container(
          ...
          decoration: const BoxDecoration(
            gradient: LinearGradient(colors: [Color(0xFF1A1A2E), Color(0xFF333333)])),
          child: const Center(
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  const Icon(CupertinoIcons.bolt_fill, size: 12, color: Colors.white),
                  const SizedBox(width: 6),
                  const Text('AI ตรวจพบ: ',
                      style: TextStyle(color: Colors.white, fontSize: 12)),
                  Text(r.aiResult!,
                      style: const TextStyle(color: Colors.white, fontSize: 12,
                          fontWeight: FontWeight.bold)),
                  const SizedBox(width: 4),
                  Text('${(r.aiConfidence! * 100).toInt()}%',
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(_getViolationName(r.typeId),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(CupertinoIcons.bolt_fill, size: 14, color: AppColors.grey500),
              SizedBox(width: 6),
              Text('ผลการวิเคราะห์ด้วย AI',
                  style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600,
                      letterSpacing: 0.8, color: AppColors.grey500)),
            ],
          ),
          const SizedBox(height: 12),
          _detailRow('ผลลัพธ์', '${r.aiResult}',
              valColor: AppColors.green),
          const SizedBox(height: 10),
          Row(
            children: [
              const SizedBox(width: 80,
                child: Text('ความมั่นใจ',
                    style: TextStyle(fontSize: 13, color: AppColors.grey500))),
              ...
              Expanded(
                child: Row(
                  children: [
                    ...
                    Text('${((r.aiConfidence ?? 0) * 100).toInt()}%',
